...
\item Integración, pruebas y validación (230 h)
	\begin{enumerate}
	\item Integración del hardware con las partes mecánicas y el gabinete preliminar. (10 h)
	\item Pruebas de funcionamiento del control térmico con excitación óptica y lectura. (40 h)
	\item Pruebas de almacenamiento de datos de lecturas en SD. (30 h)
	\item Prueba de exportación de datos almacenados en SD. (30 h)
	\item Desarrollo del algoritmo de análisis de la curva para el diagnóstico. (30 h)
	\item Calibraciones para técnicos. (10 h)
