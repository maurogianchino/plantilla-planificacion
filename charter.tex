...
El proyecto incluye:
\begin{itemize}
	\item Diseño y desarrollo de hardware
	\begin{itemize}
...
\begin{enumerate}
	\item Requerimientos funcionales y de hardware:
		\begin{enumerate}
			...
			\item La detección de la intensidad de luz debe realizarse mediante fotodiodos con filtros ópticos específicos acoplados a un conversor analógico-digital (ADC).
			...
			\item El equipo debe incorporar una memoria MicroSD para el almacenamiento local de parámetros, calibraciones y resultados.
			\item El equipo debe contar con un puerto USB para la comunicación y tareas de desarrollo/depuración.
			\item El equipo debe contar con un lector de código de barras para leer y guardar los parámetros de los reactivos.
		\end{enumerate}
	\item Requerimientos de firmware:
		\begin{enumerate}
			...
			\item El firmware debe contar con un algoritmo que interprete la evolución temporal de la medición óptica para clasificar el resultado como "Positivo" o "Negativo".
			\item El sistema debe completar el proceso de activación, lectura y entrega de resultados en un tiempo máximo de 60 minutos.
	...
	\begin{enumerate}
			\item Se debe verificar el correcto funcionamiento del lazo de temperatura mediante la medición con sensores patrón durante un intervalo de tiempo a determinar sin variaciones fuera del rango tolerado.
			\item Se debe validar el sistema óptico procesando muestras de calibración conocidas y comparando la curva de fluorescencia con la de un equipo comercial o patrón de laboratorio.
		\end{enumerate}
...
\end{center} 
    ...
    \item Como analista de laboratorio, quiero visualizar el resultado final (positivo o negativo) en la pantalla de forma clara al cabo de los 60 minutos, para poder informar el diagnóstico sin necesidad de interpretar gráficos complejos.
...
\end{center}
    ...
    \item Como técnico de mantenimiento, quiero acceder a un menú o función de calibración técnica, para poder verificar el funcionamiento individual de los LEDs RGB y calibrar las ganancias de los sensores ópticos en caso de desajustes.
    
    Hay que hacer una interfaz específica, que incluya guardado de datos de calibración y los procesos para cada componente.
    \begin{itemize}
    	\item Cantidad: 8
    	\item Complejidad: 5 
    	\item Riesgo o incertidumbre: 8
	\end{itemize}
...
\item Planificación y Gestión del Proyecto (55 h)
	...
	\item Preparación de la evaluación y cierre de proyecto. (10 h)
	\end{enumerate}

\item Investigación y Análisis Preliminar (50 h)
	\begin{enumerate}
	\item Estudio detallado de la técnica LAMP, requerimientos térmicos y ópticos. (20 h)
	\item Análisis de normativas de seguridad eléctrica aplicables en laboratorio. (10 h)
	\item Definición de la arquitectura de Hardware y Firmware del sistema. (20 h)
	\end{enumerate}

\item Desarrollo de Hardware (95 h)
	\begin{enumerate}
	\item Selección de componentes (15 h)
	\item Diseño de diagramas esquemáticos del sistema. (30 h)
	\item Diseño de los circuitos impresos (PCB) de las placas de control y sensores. (40 h)
	\item Gestión de compras de componentes y fabricación del PCB. (10 h)
	\end{enumerate}

\item Desarrollo de Firmware (210 h)
	\begin{enumerate}
	\item Configuración inicial de periféricos y \textit{drivers} de bajo nivel. (30 h)
	\item Implementación del lazo de control PID para la estabilización de temperatura. (30 h)
	\item Desarrollo de las tareas de control de LEDs y lectura sincronizada del ADC. (30 h)
	\item Desarrollo del algoritmo de análisis de la curva para el diagnóstico. (30 h)
	\item Implementación del sistema de almacenamiento temporal en memoria MicroSD. (30 h)
	\item Programación de la interfaz gráfica de usuario en la pantalla táctil. (30 h)
	\item Desarrollo de la tarea del lector de código de barras para parámetros de reactivos. (15 h)
	\item Desarrollo de las tareas de calibración (15 h)
	\end{enumerate}

\item Integración y Pruebas (110 h)
	\begin{enumerate}
	\item Integración del hardware con las partes mecánicas y el gabinete preliminar. (10 h)
	\item Pruebas de funcionamiento del control térmico. (30 h)
	\item Pruebas de detección óptica utilizando muestras de calibración controladas. (30 h)
	\item Ensayos biológicos funcionales reales aplicando la técnica LAMP. (40 h)
	\end{enumerate}

\item Documentación Final (80 h)
	\begin{enumerate}
	\item Redacción de los informes de validación térmica y óptica. (15 h)
	\item Redacción de la Memoria del Trabajo Final. (45 h)
